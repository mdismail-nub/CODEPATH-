...
export default function App() {
  return (
    <AppStateProvider>
      <Router>
        <div className="min-h-screen bg-white dark:bg-slate-950 text-slate-900 dark:text-white selection:bg-primary-500/20 selection:text-slate-900 dark:selection:bg-primary-500/30 dark:selection:text-white transition-colors duration-300">
          <Navbar />
          ...
          <footer className="mt-40 border-t border-slate-200 dark:border-slate-800 bg-white dark:bg-slate-950 py-24 relative overflow-hidden">
            <div className="mx-auto max-w-7xl px-8 text-center">
              <div className="flex flex-col items-center">
                <div className="flex items-center gap-3 mb-10">
                   <div className="h-10 w-10 flex items-center justify-center rounded-lg bg-primary-600 text-white font-bold shadow-sm">CP</div>
                ...
                <div className="h-px w-20 bg-slate-300 dark:bg-slate-700 my-12" />
                ...
                <div className="mt-20 pt-10 border-t border-slate-200 dark:border-slate-800 w-full flex flex-col md:flex-row items-center justify-between gap-6">
                   <span className="text-xs font-semibold uppercase tracking-wider text-slate-500 dark:text-slate-500">© 2026 CodePath</span>
                   <div className="flex gap-8">
                     <a href="#" className="text-xs font-semibold uppercase tracking-wider text-slate-500 dark:text-slate-500 hover:text-primary-600 dark:hover:text-primary-400 transition-colors">Privacy</a>
                     <a href="#" className="text-xs font-semibold uppercase tracking-wider text-slate-500 dark:text-slate-500 hover:text-primary-600 dark:hover:text-primary-400 transition-colors">Terms</a>
                   </div>
                </div>
              </div>
            </div>
