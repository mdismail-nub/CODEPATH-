...
import { X, Award, Send, CheckCircle2, ChevronRight, CircleDashed } from 'lucide-react';
...
export const GetCertificateModal: React.FC<GetCertificateModalProps> = ({ isOpen, onClose, topicSlug, topicName }) => {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    // Synthetic delay to show loading state
      ...
      {isOpen && (
        ...
        >
          ...
          >
            <button
              onClick={onClose}
              className="absolute right-8 top-8 text-slate-400 dark:text-slate-500 hover:text-slate-900 dark:hover:text-white transition-all duration-300 hover:rotate-90"
