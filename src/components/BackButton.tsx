...
export const BackButton = () => {
  ...
  return (
    <button 
      onClick={() => navigate(-1)}
      aria-label="Go back"
      className="group mb-8 flex items-center gap-2 text-sm font-bold text-slate-500 transition-all hover:text-slate-950 dark:hover:text-white active:scale-95"
    >
