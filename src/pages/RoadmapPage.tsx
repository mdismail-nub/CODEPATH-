 ...
 * Line(s)       : 13, 50, 83
 * Root Cause    : ROADMAP_STEPS uses mixed IDs and slugs for topic lookups, but only slugs were supported.
 * Fix Applied   : Updated lookup logic to check both id and slug; added defensive check for empty problem lists.
 * Auto-Fixed    : Yes
 * Behavior Change: No
 * ─────────────────────────────────────
 */
