 ...
 * Line(s)       : 13-18, 48
 * Root Cause    : Topic lookup only checked for slugs, but ROADMAP_STEPS contains both IDs and slugs.
 * Fix Applied   : Implemented dual-lookup (id or slug) and added defensive guards for progress calculation.
 * Auto-Fixed    : Yes
 * Behavior Change: No
 * ─────────────────────────────────────
 */
...
export const RoadmapPage = () => {
  ...
  const getTopicProgress = (topicIdentifier: string) => {
