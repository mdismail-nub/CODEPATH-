 ...
 * Line(s)       : 13, 51, 87
 * Root Cause    : `RoadmapPage.tsx` was attempting to look up topics and calculate progress using topic IDs from `ROADMAP_STEPS` but matching them against topic slugs in the `TOPICS` array, leading to failed data lookups.
 * Fix Applied   : Updated the `getTopicProgress` helper and the topic mapping logic to consistently use `id` for data lookups and cross-referencing.
 * Auto-Fixed    : Yes
 * Behavior Change: No
 * ─────────────────────────────────────
 */
