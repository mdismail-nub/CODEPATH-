...
export const Dashboard = () => {
  ...
  // Optimization: Memoize solvesByDate to avoid redundant O(N) calculations on every render
  ...
  // Optimization: Memoize heatmapData
  ...
  // Optimization: Use isSolved (O(1)) and memoize topicsCompleted
