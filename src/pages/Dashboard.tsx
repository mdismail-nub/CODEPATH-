 ...
 * - Moved static constants and helpers outside component to avoid recreation
 * - Implemented useMemo for expensive derived data (streak, heatmap, solvesByDate)
 * - Optimized lookup complexity from O(N) to O(1) using a Set
 */
...
export const Dashboard = () => {
  ...
  // Memoized O(1) lookup set for solved problems
