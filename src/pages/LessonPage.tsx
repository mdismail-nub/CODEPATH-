 ...
 * Line(s)       : 37
 * Root Cause    : React Hook "useState" is called conditionally after an early return statement, violating the Rules of Hooks.
 * Fix Applied   : Moved the "activeTab" hook declaration before the conditional early return statement.
 * Auto-Fixed    : Yes
 * Behavior Change: No
 * ─────────────────────────────────────
 */
