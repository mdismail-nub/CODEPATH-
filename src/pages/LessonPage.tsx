              ...
              <div className="mt-12 rounded-2xl overflow-hidden border border-slate-200 dark:border-slate-800 bg-slate-950 shadow-2xl">
                <div className="flex items-center justify-between px-4 py-2 bg-slate-900 border-b border-slate-800">
                  ...
                  <button
                    ...
                    className="p-1.5 rounded-lg hover:bg-slate-800 text-slate-500 hover:text-slate-300 transition-all active:scale-95 flex items-center justify-center min-w-[32px]"
                    title="Copy code" aria-label="Copy code"
                  >
                    <AnimatePresence mode="wait">
                      {copied ? (
                        <motion.div key="check" initial={{ opacity: 0, scale: 0.8 }} animate={{ opacity: 1, scale: 1 }} exit={{ opacity: 0, scale: 0.8 }} transition={{ duration: 0.15 }}><Check className="h-3.5 w-3.5 text-emerald-500" /></motion.div>
                      ) : (
                        <motion.div key="copy" initial={{ opacity: 0, scale: 0.8 }} animate={{ opacity: 1, scale: 1 }} exit={{ opacity: 0, scale: 0.8 }} transition={{ duration: 0.15 }}><Copy className="h-3.5 w-3.5" /></motion.div>
                      )}
                    </AnimatePresence>
                  </button>
                </div>
                  ...
                  <div className="flex flex-col gap-4">
                    {nextLesson ? (
                      <button
                        ...
                        className="w-full bg-primary-600 text-white px-8 py-4 rounded-2xl font-bold text-lg hover:bg-primary-700 transition-all active:scale-95 flex items-center justify-center gap-2 group"
                      >
                      ...
                      className={cn(
                        ...
                        !userAnswer 
                          ...
                          : showFeedback === 'correct'
                            ? "bg-emerald-600 dark:bg-emerald-500 hover:bg-emerald-700 border-transparent text-white shadow-lg shadow-emerald-600/10 active:scale-95"
                            : showFeedback === 'incorrect'
                              ? "bg-rose-600 dark:bg-rose-500 hover:bg-rose-700 border-transparent text-white shadow-lg shadow-rose-600/10 active:scale-95"
                              : "bg-primary-600 hover:bg-primary-700 dark:bg-primary-500 dark:hover:bg-primary-600 border-transparent text-white shadow-md shadow-primary-600/15 dark:shadow-primary-500/10 hover:scale-[1.01] active:scale-95"
                      )}
                    >
                      {showFeedback === 'correct' ? (
                        <>
