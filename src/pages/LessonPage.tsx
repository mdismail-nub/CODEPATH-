...
import { 
  ChevronLeft, CheckCircle2, ChevronRight, X, Copy, Check,
            ...
            {lesson.codeExample && (
              <div className="mt-12 rounded-2xl overflow-hidden border border-slate-200 dark:border-slate-800 bg-slate-950 shadow-2xl">
                <div className="flex items-center justify-between px-4 py-2 bg-slate-900 border-b border-slate-800">
                  ...
                  <button
                    onClick={handleCopy}
                    className="p-1.5 rounded-lg hover:bg-slate-800 text-slate-500 hover:text-slate-300 transition-all active:scale-90"
                    title="Copy code"
