 ...
 * Line(s)       : 24-44
 * Root Cause    : Component state (isCompleted, currentExerciseIdx, etc.) was not reset when navigating between different lessons, leading to incorrect UI states.
 * Fix Applied   : Added a useEffect hook to reset all exercise-related states when courseSlug or lessonSlug changes.
 * Auto-Fixed    : Yes
 * Behavior Change: Yes (Correctly resets lesson progress UI when switching lessons)
 * ─────────────────────────────────────
 */
