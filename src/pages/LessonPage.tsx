              ...
              <div className="mt-12 rounded-2xl overflow-hidden border border-slate-200 dark:border-slate-800 bg-slate-950 shadow-2xl">
                <div className="flex items-center justify-between px-4 py-2 bg-slate-900 border-b border-slate-800">
                  ...
                  <button
                    ...
                    className="p-1.5 rounded-md hover:bg-slate-800 transition-colors group/copy active:scale-95"
                    title="Copy code"
                    ...
                    <AnimatePresence mode="wait">
                      {copied ? (
                        ...
                        <motion.div
                          ...
                          exit={{ scale: 0.5, opacity: 0 }}
                        >
                          <Copy className="h-3 w-3 text-slate-600 group-hover/copy:text-slate-400 transition-colors" />
                        </motion.div>
                      )}
                    </AnimatePresence>
                  </button>
