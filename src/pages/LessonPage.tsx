 ...
 * Line(s)       : 31-40
 * Root Cause    : React Hook 'setActiveTab' was called conditionally after an early return, and lack of defensive guards on 'lesson.exercises' could lead to crashes.
 * Fix Applied   : Moved 'setActiveTab' state declaration to the top level and added optional chaining/fallback values for exercise-related calculations.
 * Auto-Fixed    : Yes
 * Behavior Change: No
 * ─────────────────────────────────────
 */
