...
export const LessonPage = () => {
  ...
  const handleCopyCode = () => {
    if (lesson.codeExample && navigator.clipboard) {
              ...
              <div className="mt-12 rounded-2xl overflow-hidden border border-slate-200 dark:border-slate-800 bg-slate-950 shadow-2xl">
                <div className="flex items-center justify-between px-4 py-2 bg-slate-900 border-b border-slate-800">
                  ...
                  <button
                    ...
                    className="p-1.5 rounded-md hover:bg-slate-800 text-slate-500 hover:text-white transition-colors flex items-center gap-1.5 group/copy"
                  ...
                  >
                    ...
                    <span className="text-[10px] font-bold uppercase tracking-widest opacity-0 group-hover/copy:opacity-100 transition-opacity">
                      {copied ? 'Copied!' : 'Copy'}
                    </span>
                  </button>
                </div>
