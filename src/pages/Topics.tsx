...
export const Topics = () => {
  ...
  /**
   * Performance Optimization: Memoize filtered topics list.
   * Prevents nested O(N*M) filtering logic (Topics * Problems) on every render.
   * Impact: Maintains search responsiveness and reduces main thread blocking.
   */
