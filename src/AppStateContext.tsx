...
export const AppStateProvider: React.FC<{ children: React.ReactNode }> = ({ children }) => {
  ...
  // BOLT OPTIMIZATION: Memoize sets for O(1) lookups
  ...
  const toggleTheme = useCallback(() => {
    setTheme(prev => {
      ...
      localStorage.setItem('codepath_theme', newTheme);
      return newTheme;
    });
  }, []);
  ...
  // BOLT OPTIMIZATION: Memoize context value to prevent unnecessary re-renders in consumers
