...
export const AppStateProvider: React.FC<{ children: React.ReactNode }> = ({ children }) => {
  ...
  const lessonCompletedSet = useMemo(() => new Set(stats.completedLessonIds || []), [stats.completedLessonIds]);
  ...
  const isLessonCompleted = useCallback((lessonId: string) => lessonCompletedSet.has(lessonId), [lessonCompletedSet]);
